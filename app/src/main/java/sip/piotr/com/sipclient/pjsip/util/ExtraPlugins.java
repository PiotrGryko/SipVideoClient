...
import sip.piotr.com.sipclient.pjsip.NativeLibManager;
...
public class ExtraPlugins {
	...
	public static class DynCodecInfos {
        ...
        public DynCodecInfos(String libraryPath, String factoryInitFunction, String factoryDeinitFunction)
        {
            this.libraryPath=libraryPath;
            this.factoryInitFunction=factoryInitFunction;
            this.factoryDeinitFunction=factoryDeinitFunction;
        }
    ...
    public static Map<String, DynCodecInfos> getVideoCodecPlugins(Context ctxt, String action){
        if(!CACHED_RESOLUTION.containsKey(action)) {
            HashMap<String, DynCodecInfos> plugins = new HashMap<String, DynCodecInfos>();
            plugins.put("one",new DynCodecInfos(NativeLibManager.getLibraryPath(ctxt, "libpj_video_android.so"),
                    "pjmedia_codec_ffmpeg_vid_init", "pjmedia_codec_ffmpeg_vid_deinit"));
            plugins.put("two",new DynCodecInfos(NativeLibManager.getLibraryPath(ctxt, "libpj_vpx.so"),
