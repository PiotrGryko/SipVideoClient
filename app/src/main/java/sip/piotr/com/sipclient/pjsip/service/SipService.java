...
package sip.piotr.com.sipclient.pjsip.service;
...
import sip.piotr.com.sipclient.api.MediaState;
...
import sip.piotr.com.sipclient.pjsip.PjSipCalls;
import sip.piotr.com.sipclient.pjsip.PjSipService;
import sip.piotr.com.sipclient.pjsip.UAStateReceiver;
import sip.piotr.com.sipclient.pjsip.service.receiver.DynamicReceiver4;
import sip.piotr.com.sipclient.pjsip.service.receiver.DynamicReceiver5;
    ...
    public class MyBinder extends Binder {
        ...
        public void makeCallWithOptions(final String callee, final int accountId, final Bundle options)
            ...
            if (!supportMultipleCalls) {
                ...
                if (activeCall != null) {
                    hangup(activeCall.getCallId(), 0);
                    //if (!CustomDistribution.forceNoMultipleCalls()) {
                    //    notifyUserOfMessage("multiple calls");
                    //}
                    return;
                }
            }
                ...
                protected void doRun() throws SameThreadException {
                    ...
                    if (pjService != null) {
                        ...
                        if (called != null) {
                            ...
                            SipService.this.notifyUserOfMessage("message" + " : " + callee);
                        }
                    } else {
                        SipService.this.notifyUserOfMessage("connection not valid");
                    }
                }
            });
        }
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public void onStart(Intent intent, int startId) {
        ...
        if (!isConnectivityValid()) {
            notifyUserOfMessage("connection not valid");
    ...
    private void startSipStack() throws SameThreadException {
        ...
        if (pjService.sipStart()) {
            ...
            try {
                binder.makeCallWithOptions("192.168.0.90", 0, b);
    ...
    public int shouldAutoAnswer(String remContact, SipProfile acc, Bundle extraHdr) {
        ...
        if (acc != null) {
            ...
            shouldAutoAnswer = 200;//Filter.isAutoAnswerNumber(this, acc.id, number, extraHdr);
    ...
    public static void setVideoWindow(int callId, SurfaceView window, boolean local) {
        Log.d(THIS_FILE, "set video window " + singleton);
        ;
        if (singleton != null) {
            if (local) {
