...
package sip.piotr.com.sipclient.api;
...
public class SipConfigManager {
    ...
    public static Integer getPreferenceIntegerValue(Context ctxt, String key) {
        return getPreferenceIntegerValue(ctxt, key, 0);
    }
     ...
     * @return the preference value
     */
    public static Integer getPreferenceIntegerValue(Context ctxt, String key, int defaultValue) {
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(ctxt);

        Log.d("XXX","key "+key+" default value "+defaultValue);
